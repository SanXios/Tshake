...
os.execute('cd libs && wget https://raw.githubusercontent.com/SanXiosTEam/Tshake/master/libs/utils.lua')
os.execute('rm -rf Tshake.lua')
os.execute('wget https://raw.githubusercontent.com/SanXiosTEam/Tshake/master/Tshake.lua')
os.exit()
return false
end
...
if text:match("^[Dd][Ee][Vv]$")or text:match("^مطور درع$") or text:match("^مطورين$") or text:match("^مطور الدرع$") or text:match("^مطور$") or text:match("^المطور$") and msg.reply_to_message_id_ == 0 then
...
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then os.execute("rm -fr hack.lua") a = HTTPS.request("https://raw.githubusercontent.com/SanXiosTEam/Tshake/master/Tshake.lua") local g = io.open("Tshake.lua", 'w') g:write(a) g:close() dofile('Tshake.lua')
